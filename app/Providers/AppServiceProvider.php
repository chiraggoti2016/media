...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        view()->composer(['layouts.checkout.footer', 'cart.addons.internet', 'cart.addons.home-phone', 'cart.step.installation','cart.step.summary','cart.step.internet', 'cart.step.tv'], function ($view) {
