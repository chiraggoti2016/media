      ...
      <section id="speakers" class="about-all-plans wow" style="padding: 60px 0 200px 0;">
        <div class="container">
          <div class="row">
            <p class="svg-75">
              @include("svg.home-security")
              Choose Your Home Phone</p>
          </div>
          <div class="row">
            <div class="col-lg-9">
              <h3>Home Security Plans</h3>
              @if(isset($plan))
            ...
            @if(isset($plan))            
              <div class="col-lg-3 text-center change-link-container" style="display: none;">
            ...
            <div class="row" id="alternate-container" style="{{ isset($plan) ? '' : ''}}">
