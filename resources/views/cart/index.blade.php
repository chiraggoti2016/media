        ...
        <div class="row">
          <div class="col-lg-3 text-center service">
            ...
            <label class="checkbox">
              <input type="checkbox" name="plantype[]" id="checkbox-internet" value="internet" />
          ...
          <div class="col-lg-3 text-center service">
            ...
            <h3>TV</h3>
            <label class="checkbox">
              <input type="checkbox" name="plantype[]" id="checkbox-tv" value="tv" />
              <span class="checkmark"></span>
            </label>
          </div>
          <div class="col-lg-3 text-center service">
            ...
            <h3>Home Phone</h3>
            <label class="checkbox">
              <input type="checkbox" name="plantype[]" id="checkbox-home_phone" value="home_phone" />
              <span class="checkmark"></span>
            </label>
          </div>
          <div class="col-lg-3 text-center service">
            ...
            <h3>Home Security</h3>
            <label class="checkbox">
              <input type="checkbox" name="plantype[]" id="checkbox-home_security" value="home_security" />
              <span class="checkmark"></span>
            </label>
          </div>
        </div>
