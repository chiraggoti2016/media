        ...
        @elseif($options->type == 'belongsToMany')
            ...
            @if(isset($view) && ($view == 'browse' || $view == 'read'))
                ...
                @else
                    ...
                    @else
                        <p>
                            @foreach($selected_values as $selected_value)
                                @php echo $selected_value; @endphp
                            @endforeach
                        </p>
                    @endif
                @endif
            ...
            @else
                ...
                @foreach($relationshipOptions as $relationshipOption)
                    <div class="col-sm-2">
                        <input type="checkbox" name="{{ $relationshipField }}[]" value="{{ $relationshipOption->{$options->key} }}" @if(in_array($relationshipOption->{$options->key}, $selected_values)){{ 'checked="checked"' }}@endif /> 
                        @php echo $relationshipOption->logo_tag; @endphp
                    </div>
                @endforeach
                </div>
